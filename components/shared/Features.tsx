                ...
                <div className="container py-5">
                    <div className="row">
                        <div className="col-lg-4 my-2 position-relative">
                            <span className="text-back">01</span>
                            <h3 className="h3 font-weight-light mb-4">Stability</h3>
                        ...
                        <div className="col-lg-4 my-2 position-relative">
                            <span className="text-back">02</span>
                            <h3 className="h3 font-weight-light mb-4">Credibility</h3>
                            <p className="text-muted">
                        ...
                        <div className="col-lg-4 my-2 position-relative">
                            <span className="text-back">03</span>
                            <h3 className="h3 font-weight-light mb-4">Customizability</h3>
                            <p className="text-muted">
